...
class TestMaskVoting(unittest.TestCase):
    ...
    def test_mask_voting_cpu(self):
        self.check_mask_voting(
            self.roi_mask_prob, self.roi_prob, self.bbox,
            self.roi_size, self.size, self.n_class, self.bg_label)
