...
from chainercv.datasets.omniglot.omniglot_dataset import OmniglotDataset  # NOQA
from chainercv.datasets.omniglot.omniglot_label_names import omniglot_label_names  # NOQA
