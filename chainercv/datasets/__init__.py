...
from chainercv.datasets.visual_genome.visual_genome_utils import VisualGenomeDatasetBase  # NQDA
from chainercv.datasets.visual_genome.visual_genome_region_descriptions_dataset import VisualGenomeRegionDescriptionsDataset  # NQDA
