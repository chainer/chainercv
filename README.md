...
The HEAD of the master branch is developed for Chainer v3 and Cupy v2.
For users using Chainer v2 and Cupy v1, please use version 0.6, which can be installed by `pip install chainercv==0.6`.
