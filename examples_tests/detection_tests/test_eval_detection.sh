...
$PYTHON eval_detection_multi.py --dataset voc --model ssd300 --batchsize 2 --gpu 0
$PYTHON eval_detection_multi.py --dataset coco --model faster_rcnn_fpn_resnet50 --batchsize 2 --gpu 0
